...
<seelog minlevel="` + LogLevel + `">
    ...
    <formats>
        <format id="common"   format="[GeoSkeleton] %Date %Time [%LEVEL] %File %FuncShort:%Line %Msg %n" />
        <format id="stdout"   format="[GeoSkeleton] %Date %Time [%LEVEL] %File %FuncShort:%Line %Msg %n" />
    </formats>
</seelog>
`
